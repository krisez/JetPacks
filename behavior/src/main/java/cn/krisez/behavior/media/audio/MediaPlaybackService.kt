...
class MediaPlaybackService : MediaBrowserServiceCompat() {
    ...
    private val dataSourceFactory: DefaultDataSourceFactory by lazy {
        DefaultDataSourceFactory(
                /* context= */ this, Util.getUserAgent(/* context= */ this, UAMP_USER_AGENT), /* listener= */
                               null)
    }
    ...
    override fun onCreate() {
        ...
        Log.d("MediaPlaybackService.kt", "onCreate: ")
    ...
    override fun onGetRoot(
        ...
        Log.d("MediaPlaybackService.kt", "onGetRoot: $clientPackageName")
        /*
    ...
    override fun onLoadChildren(
        ...
        Log.d("MediaPlaybackService.kt", "onLoadChildren: $parentMediaId")
        /**
        ...
        if (parentMediaId == UAMP_RECENT_ROOT) {
            ...
            val resultsSent = mediaSource.whenReady { successfullyInitialized ->
                Log.d("MediaPlaybackService.kt", "onLoadChildren: $successfullyInitialized")
                if (successfullyInitialized) {
                    val children = browseTree[parentMediaId]?.map { item ->
                        MediaBrowserCompat.MediaItem(item.description, item.flag)
                    }
                    Log.d("MediaPlaybackService.kt", "onLoadChildren: ${Gson().toJson(children)}")
    ...
    private fun switchToPlayer(previousPlayer: Player?, newPlayer: Player) {
        ...
        currentPlayer.repeatMode = REPEAT_MODE_ONE
        if (previousPlayer != null) {
            ...
            if (currentPlaylistItems.isEmpty()) {
                ...
                preparePlaylist(metadataList = currentPlaylistItems, itemToPlay = currentPlaylistItems[previousPlayer.currentWindowIndex], playWhenReady = previousPlayer.playWhenReady, playbackStartPositionMs = previousPlayer.currentPosition)
            }
        }
    ...
    private inner class UampPlaybackPreparer : MediaSessionConnector.PlaybackPreparer {
         ...
         */
        override fun getSupportedPrepareActions(): Long = PlaybackStateCompat.ACTION_PREPARE_FROM_MEDIA_ID or PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID or PlaybackStateCompat.ACTION_PREPARE_FROM_SEARCH or PlaybackStateCompat.ACTION_PLAY_FROM_SEARCH
        ...
        override fun onPrepareFromMediaId(
            ...
            mediaSource.whenReady {
                ...
                if (itemToPlay == null) {
                    ...
                    val playbackStartPositionMs = extras?.getLong(MEDIA_DESCRIPTION_EXTRAS_START_PLAYBACK_POSITION_MS, TIME_UNSET) ?: TIME_UNSET
        ...
        override fun onPrepareFromSearch(query: String, playWhenReady: Boolean, extras: Bundle?) {
            mediaSource.whenReady {
                ...
                if (metadataList.isNotEmpty()) {
                    preparePlaylist(metadataList, metadataList[0], playWhenReady, playbackStartPositionMs = TIME_UNSET)
                }
            }
        }
         ...
         */
        private fun buildPlaylist(item: MediaMetadataCompat): List<MediaMetadataCompat> = mediaSource.filter { it.album == item.album }
    ...
    private inner class PlayerNotificationListener :
        ...
        override fun onNotificationPosted(
            ...
            if (ongoing && !isForegroundService) {
                ContextCompat.startForegroundService(applicationContext, Intent(applicationContext, this@MediaPlaybackService.javaClass))
